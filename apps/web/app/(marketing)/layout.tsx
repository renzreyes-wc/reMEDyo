        ...
        <div className="mx-auto w-full max-w-6xl px-4 py-10 sm:px-6">
          <div className="flex flex-wrap items-start justify-between gap-8">
            ...
            <div className="flex flex-wrap gap-x-12 gap-y-6 text-sm">
              <div>
                <p className="font-semibold text-ink-900">Patients</p>
                <ul className="mt-2 space-y-1.5 text-ink-500">
                  <li><Link href="/register/patient" className="hover:text-brand-700">Create an account</Link></li>
              ...
              <div>
                <p className="font-semibold text-ink-900">Doctors</p>
                <ul className="mt-2 space-y-1.5 text-ink-500">
                  <li><Link href="/register/doctor" className="hover:text-brand-700">Join as a doctor</Link></li>
                  <li><Link href="/login" className="hover:text-brand-700">Doctor sign in</Link></li>
                </ul>
              </div>
              <div>
          ...
          <div className="mt-8 border-t border-ink-200 pt-6 text-sm text-ink-500">
            <p>
